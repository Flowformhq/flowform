...
return [
    ...
    'auth' => [
        ...
        'extra_info' => 'Authenticate by sending a Bearer token in the <b>Authorization</b> header. Generate tokens via Laravel Sanctum: <code>$user->createToken("my-app")->plainTextToken</code>.',
    ],
